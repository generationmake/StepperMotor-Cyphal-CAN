/**
 * Stepper Motor firmware for the CyphalPicoBase-CAN (https://github.com/generationmake/CyphalPicoBase-CAN)
 *
...
static uint16_t const UPDATE_PERIOD_LED_ms = 1000;
...
static std::string node_description{"StepperMotor-Cyphal/CAN"};
...
void loop()
{
  ...
  if((now - prev_led) > UPDATE_PERIOD_LED_ms)
  {
